...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<activemodel>.freeze, ["< 6.2", ">= 4.1"])
      s.add_runtime_dependency(%q<actionpack>.freeze, ["< 6.2", ">= 4.1"])
      s.add_development_dependency(%q<railties>.freeze, ["< 6.2", ">= 4.1"])
      s.add_development_dependency(%q<minitest>.freeze, ["< 5.11", "~> 5.0"])
      s.add_runtime_dependency(%q<jsonapi-renderer>.freeze, ["< 0.3", ">= 0.1.1.beta1"])
      s.add_runtime_dependency(%q<case_transform>.freeze, [">= 0.2"])
      s.add_development_dependency(%q<activerecord>.freeze, ["< 6.2", ">= 4.1"])
      ...
      s.add_dependency(%q<activemodel>.freeze, ["< 6.2", ">= 4.1"])
      s.add_dependency(%q<actionpack>.freeze, ["< 6.2", ">= 4.1"])
      s.add_dependency(%q<railties>.freeze, ["< 6.2", ">= 4.1"])
      s.add_dependency(%q<minitest>.freeze, ["< 5.11", "~> 5.0"])
      s.add_dependency(%q<jsonapi-renderer>.freeze, ["< 0.3", ">= 0.1.1.beta1"])
      s.add_dependency(%q<case_transform>.freeze, [">= 0.2"])
      s.add_dependency(%q<activerecord>.freeze, ["< 6.2", ">= 4.1"])
