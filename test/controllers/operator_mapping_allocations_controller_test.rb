...
class OperatorMappingAllocationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operator_mapping_allocation" do
    assert_difference('OperatorMappingAllocation.count') do
      post operator_mapping_allocations_url, params: { operator_mapping_allocation: { operator_allocation_id: @operator_mapping_allocation.operator_allocation_id, operator_id: @operator_mapping_allocation.operator_id } }, as: :json
    end
  ...
  test "should update operator_mapping_allocation" do
    patch operator_mapping_allocation_url(@operator_mapping_allocation), params: { operator_mapping_allocation: { operator_allocation_id: @operator_mapping_allocation.operator_allocation_id, operator_id: @operator_mapping_allocation.operator_id } }, as: :json
    assert_response 200
  end
